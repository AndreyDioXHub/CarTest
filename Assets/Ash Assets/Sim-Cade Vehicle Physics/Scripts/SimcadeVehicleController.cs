...
namespace Ashsvp
{
    public class SimcadeVehicleController : MonoBehaviour
    {
		...
		[HideInInspector]
        public float steerInput, accelerationInput, rearTrack, wheelBase, ackermennLeftAngle, ackermennRightAngle;
		...
		public void OnMove(InputAction.CallbackContext context)
		{
            ...
            Vector2 axisMovement = context.ReadValue<Vector2>();

			if (CanDrive && CanAccelerate)
			{
				accelerationInput = axisMovement.y;
